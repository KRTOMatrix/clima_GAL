...
var div = L.DomUtil.create('div', 'info2');
	 div.innerHTML +=
	 'VISOR CARTOGRÁFICO<h2>Clima e cambio climático recente <br>Provincia da Coruña';
	 return div;
	};
	title2.addTo(map);
//Logo Matrix	
...
function popup12(feature, layer) {
	...
	if (feature.properties && feature.properties.Prec_rel) {
		layer.bindTooltip("<strong>Cambio na precipitación: </strong>"+  
			feature.properties.Prec_rel.toFixed(1).toString().replace(".", ",")+
...
},
{
	...
	children: [
	    ...
	    { label: "Tipos de cambio climático",layer: mapa13}
	...
	var htmlLegend6 = L.control.htmllegend({
		...
		image:'<img src="images/LOGO_GEN.png"',
			...
			elements: [{
				...
				label:"<h5>"+'<br>'+"<\h5>",html: '',style: {'background-color': 'write','width': '0px','height': '0px'}}, { 
				label:"<h4>"+  'Método: modelización estatística e interpolación espacial.<br> Resolución: 100 m'+"<\h4>",html: '',style: {'background-color': 'write','width': '0px','height': '0px'}}, {
				label:'<br><img src="images/prec_med.jpg",></img><br>',
				IMG:"<h3>"+  'Unidades: ‰'+"<\h4>",html: '',style: {'background-color': 'write','width': '0px','height': '0px'}}, {
				//label:"<h3>"+'<br>Unidades: %<br>'+"<\h4>",html: '',style: {'background-color': 'write','width': '0px','height': '0px'}}, {
...
var htmlLegend7 = L.control.htmllegend({
	...
	var htmlLegend11 = L.control.htmllegend({
		...
		image:'<img src="images/LOGO_GEN.png"',
			...
			elements: [{
			    ...
			    label:"<h4>"+  '&nbsp 0,5 – 0,7'+"<\h4>",html: '',style: {'background-color': '#ffecbd','width': '40px','height': '14px', 'border': 'black 1px solid'}}, {	
	...
	var htmlLegend12 = L.control.htmllegend({
		...
		image:'<img src="images/LOGO_GEN.png"',
			...
			elements: [{
			    ...
			    label:"<h4>"+  '&nbsp -5,0 – 0'+"<\h4>",html: '',style: {'background-color': '#ffecbd','width': '40px','height': '14px', 'border': 'black 1px solid'}}, {	
				label:"<h4>"+  '&nbsp  0,1 – 5'+"<\h4>",html: '',style: {'background-color': '#abe9ff','width': '40px','height': '14px', 'border': 'black 1px solid'}}, {		
			    label:"<h4>"+  '&nbsp  5,1 – 10'+"<\h4>",html: '',style: {'background-color': '#004cac','width': '40px','height': '14px', 'border': 'black 1px solid'}}, {	
				label: "<h5>" +'<BR><i>Fonte: CLIMACO. Elaboración propia con datos da Axencia Estatal de Meteoroloxía (2020).<i><BR>'+"<\h5>",html: '',style: {'background-color': 'write','width': '0px','height': '0px'}																
	...
	map.addControl(htmlLegend12);
		...
		image:'<img src="images/LOGO_GEN.png"',
			...
			elements: [{
		    	...
		    	label:'<br><img src="images/leg_cat.png",></img><br>',
	...
	map.addControl(htmlLegend13);
		...
		position: 'bottomleft',
		legends: [{
			name: "<h3>"+ 'Tipos de clima'+"<\h3><h4><br>Baseados na temperatura e precipitación media anual. Período 1981-2010</h4>",
			layer: geojson14,
		image:'<img src="images/LOGO_GEN.png"',
	...
	map.addControl(htmlLegend14);
		...
		position: 'bottomleft',
		legends: [{
			name: "<h3>"+ 'Variantes locais de clima oceánico.'+"<\h3>",
			layer: geojson15,
		image:'<img src="images/LOGO_GEN.png"',
